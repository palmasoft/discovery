...
<body style="text-align: justify;">
	...
	<div style="text-align: center;">
		<h3>
			POR US $ <strong style="text-decoration: underline;"><?php print_r($contrato->saldoInicial) ?></strong>
		</h3>
		<br>
	</div>

	<div style="text-align: justify;">
		Debo y pagaré incondicionalmente a la orden de <strong>Discovery Travel Discotravelcom S.A.</strong>, en esta ciudad o en el lugar donde se me reconvenga,
		 la cantidad de <strong><?php echo strtoupper(valorEnLetras($contrato->saldoInicial)); ?> DÓLARES DE LOS ESTADOS UNIDOS DE AMÉRICA
			 (USD $ <?php print_r($contrato->saldoInicial) ?>)</strong>,
	...
	<table id="pagare" style="width: 100%;">
					...
					if (count(@$pagare)<13) {
						...
						<td style="text-align: justify;">
							...
							<tbody>
								...
								?>
									<tr style="text-align: justify;">
										<td style="text-align: justify;"><?php echo $intqq; ?></td>
										<td style="text-align: justify;"><?php echo $rass->saldo; ?></td>
										<td style="text-align: justify;"><?php echo $rass->fecha; ?></td>
									</tr>
								<?php
								$intqq++;
								}?>
	...
	<div style="text-align: justify;">
		...
		En caso de juicio hago una renuncia general de domicilio y quedo expresamente sometido a los Jueces competentes de esta ciudad de Quito o del lugar en que se me reconvenga,
