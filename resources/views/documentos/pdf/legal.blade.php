  ...
  <style>
    ...
    <section class="container-fluid mt-7">
        <center>
            ...
            <p class="h6"><b>Discovery Travel Discotravelcom S.A.</b></p>
        ...
        <article class="text-justify">
            <p>
              ...
              <est class="font2">
                ...
                y la Compañía Discovery Travel Discotravelcom S.A..
              </est>
            </p>
            <br><br>
            <p>
    ...
    @if (@$tipo == 2 || $tipo == 3 || $tipo == 4 || $tipo == 5)
        ...
        <article class="text-justify font-size">
            ...
            <ul>
                <li>
                    <p><b>1.1</b> La empresa <b>Discovery Travel Discotravelcom S.A.</b>,  debidamente representada por la señora HAYDITH YANINE RUIZ DITTA , en su calidad de Representante Legal ; y por otra parte,</p>
                </li>
                <li>
            ...
            <p>
              @if ($tipo == 2)
                ...
                <b>Discovery Travel Discotravelcom S.A.</b>, a su entera satisfacción y como parte del acuerdo alcanzado, un canje por 
            ...
            @if ($tipo == 3)
                ...
                <b>Discovery Travel Discotravelcom S.A.</b>, un canje por servicio equivalente al valor cancelado por la 
              ...
              @if ($tipo == 5)
                  ...
                  <b>Discovery Travel Discotravelcom S.A.</b>, a su entera satisfacción y como parte del acuerdo alcanzado, la cantidad de
                  <b>{{ valorEnLetras(@$devolucion) }} DÓLARES DE LOS ESTADOS UNIDOS DE AMÉRICA (USD {{ @$devolucion }})</b>,
                ...
                @if ($tipo == 4)
                    ...
                    <b>Discovery Travel Discotravelcom S.A.</b>, ninguna compensación económica por cuanto el valor cancelado de
                    <b>{{ valorEnLetras(@$devolucion) }} DÓLARES DE LOS ESTADOS UNIDOS DE AMÉRICA (USD {{ @$devolucion }})</b>,
            ...
            <ul>
                <li>
                    <p><b>5.1</b> El Señor <b>{{ strtoupper($contrato->titularNombre) }}</b>, 
                      ...
                      ni en el presente ni en el futuro, en contra de la empresa <b>Discovery Travel Discotravelcom S.A.</b>, ni de 
                ...
                <li>
                    <p>
                        @if (@$tipo == 2 || $tipo == 3 || $tipo == 4)
                            ...
                            que la empresa <b>Discovery Travel Discotravelcom S.A.</b>, sus empresas relacionadas o subsidiarias, y/o sus 
                        ...
                        @else
                            ...
                            iniciado en contra de <b>Discovery Travel Discotravelcom S.A.</b>, sus empresas relacionadas o subsidiarias, 
        ...
        <article class="text-justify font-size">
            ...
            <table style="border: none; width:100%;">
                <tr>
                    <td>
                        <p>
                        <b>Discovery Travel Discotravelcom S.A.</b></p>
                    </td>
                    <td>
